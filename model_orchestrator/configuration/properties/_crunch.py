...
class InfrastructureConfig(_BaseConfig):
    ...
    runner_env: Dict[str, str] = Field(default_factory=dict, description="Additional environment variables injected into runner containers. Passed as-is to the ECS task definition (e.g. GRPC_TRACE, GRPC_VERBOSITY, SANDBOX_PROXY_URL).")
